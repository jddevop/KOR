        		...
        		<div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="panel-heading m-b-15">
            						...
            						<a class="btn btn-info btn-rounded" href="{{ route('occupations.create') }}"> Add Occupations</a>
            				</div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
											...
											@endif
												...
												<input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox changestatus" id="switch_sick{{ $i }}" data-table="occupations" data-field="status" data-id-name="id" data-id="{{ $data->id }}" {{ $status_chk }}  value="1">
												<label class="onoffswitch-label" for="switch_sick{{ $i }}">
													<span class="onoffswitch-inner"></span>
													<span class="onoffswitch-switch"></span>
												</label>
												</div></td>
                                            <td><a href="{{ route('occupations.edit',$data['id']) }}"><i class="fa fa-edit"></i></a> &nbsp;&nbsp;<a href="javascript:void(0)" data-id="{{ $data->id }}" class="data_delete"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                        @php($i++)
										@endforeach
                                    </tbody>
