	        ...
	        <div class="row">
        		<div class="col-md-6 col-md-offset-3">
        		    ...
        		    <div class="panel panel-info">
                            <div class="panel-heading"> {{ $mode }} English Level</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                            
                            <form class="form-horizontal" method="post" action="{{ (Request::route()->getName() == 'english_level.edit') ? route('english_level.update', (isset($data->id)) ? $data->id : '') : route('english_level.store') }}" enctype="multipart/form-data">
                                @if (Request::route()->getName() == 'english_level.edit')
									@method('PATCH')
								@endif
								@csrf
								<div class="form-body">
